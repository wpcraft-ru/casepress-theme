<?php
	...
	//global $wpdb; $count = $wpdb->get_var('SELECT COUNT(comment_ID) FROM ' . $wpdb->comments. ' WHERE comment_type <>'"notification"'');?>
			<section id="comments" class="cases-box cases-box-open">
				<div class="cases-box-header">
					<h3>
						<a href="#" class="cases-box-toggle"><?php 
						comments_number( 'Комментарии', 'Комментарии (1)', 'Комментарии (%)' ); 
	...
	<?php if ( have_comments() ) {
			if (isset($comment) && $comment->comment_type=='')
			{	?>
			<section id="comments" class="cases-box cases-box-open">
				<div class="cases-box-header">
					<h3>
						<a href="#" class="cases-box-toggle">
						<?php 
					//	comments_number( 'Комментарии', 'Комментарии (1)', 'Комментарии (%)' );?> 
						Комментарии <?php /*echo count( $wp_query->comments_by_type[''] )*/ ?>			  
