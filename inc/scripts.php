<?php
	...
	function roots_scripts() {
		...
		if ( is_child_theme() ) {
			wp_enqueue_style( 'roots_app_style', get_stylesheet_directory_uri() . '/css/app.css', false, null );
		} else {
		...
		if ( !is_child_theme() ) {
			...
			wp_register_script( 'roots_plugins', get_stylesheet_directory_uri() . '/js/plugins.js', false, null, false );
			wp_register_script( 'roots_main', get_stylesheet_directory_uri() . '/js/main.js', false, null, false );
			wp_enqueue_script( 'roots_plugins' );
			wp_enqueue_script( 'roots_main' );
		}
	}
