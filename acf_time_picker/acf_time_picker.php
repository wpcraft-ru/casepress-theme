...
class acf_time_picker extends acf_Field
{
	...
	*-------------------------------------------------------------------------------------*/
	...
	{
		$field['timepicker_show_date_format'] = 'dd.mm.yy';;
		$field['timepicker_date_format'] = 'dd.mm.yy';
...
<script>
 ...
 var name_input = document.getElementById('testid');
name_input.value='2012-09-12 11:01';
	...
	*-------------------------------------------------------------------------------------*/
	...
	function create_field($field)
	{
        ...
        if ($field['timepicker_show_date_format'] != 'true') {
	        ...
	        echo '<input type="text" id="testid" name="' . $field['name'] . '" class="time_picker" value="' . $field['value'] . '" data-date_format="yy-mm-dd" data-time_format="' . $time_format . '" data-show_week_number="' . $show_week_number . '"  title="' . $title . '" />';    
        }
 	}
